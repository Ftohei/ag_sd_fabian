...
public class Searcher {
     ...
     * @throws IOException
     */
    public Searcher(String indexDir, int numberOfEsaResults, Language language) throws IOException{
     ...
     */
    public GroupWithResults addResultsToGroup(GroupWithResults group, String inputGetaggt,boolean onlyPersons){
        ...
        this.search(nounAdjectiveQuery,onlyPersons);
    ...
    public String searchWithReturn(String query, boolean onlyPersons){
        this.pageIds.clear();
        this.scores.clear();
        this.titles.clear();
        search(query,onlyPersons);
        String output = "";
        for(String s: titles) output+=" "+s;
        
        return output;
    }
    
    
    public String searchAndReturnJSON(String query, boolean onlyPersons){
        this.pageIds.clear();
        this.scores.clear();
        this.titles.clear();
        search(query,onlyPersons);
    ...
    public void search(String query, boolean onlyPersons){
